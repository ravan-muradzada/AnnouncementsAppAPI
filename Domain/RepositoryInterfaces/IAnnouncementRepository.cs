...
namespace Domain.RepositoryInterfaces
{
    public interface IAnnouncementRepository
    {
        ...
        Task<Announcement?> GetByIdAsync(Guid announcementId, Guid? userId = null, bool? isPublished = null, bool? isExpired = null, CancellationToken ct = default);
        Task<List<Announcement>> GetAllAsync(Guid? userId = null, bool? isPublished = null, bool? isExpired = null, CancellationToken ct = default);
        ...
        Task<bool> ExistsAsync(Guid announcementId, Guid? userId = null, bool? isExpired = null, CancellationToken ct = default);
    }
}
