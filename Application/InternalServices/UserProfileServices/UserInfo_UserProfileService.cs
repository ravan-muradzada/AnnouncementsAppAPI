...
{
    public class UserInfo_UserProfileService : IUserInfo_UserProfileService
    {
        #region Fields
        ...
        #region Constructor
        public UserInfo_UserProfileService(UserManager<ApplicationUser> userManager, IMapper mapper, IEmailService emailService, IRedisRepository redisRepository, IRefreshTokenService refreshTokenService)
        {
